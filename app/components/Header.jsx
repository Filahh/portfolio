  ...
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      className='flex items-end gap-2 text-xl md:text-2xl mb-2 font-Ovo'>
        Hi! I'm Henry Victor <Image src={assets.hand_icon} alt='' className='w-6'/></motion.h3>
        <motion.h1 
         initial={{ y: -30, opacity: 0 }}
        whileInView={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.8, delay:0.5 }}
        className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>Frontend Developer In Lagos
        </motion.h1>
        <motion.p 
         initial={{opacity: 0 }}
        ...
        className="max-w-2xl mx-auto font-Ovo">
            I'm a frontend developer from Lagos with a passion for creating beautiful and functional web applications. I specialize in React and have experience with various frontend technologies.
        </motion.p>
